...
Namespace Power_Diary
    ...
    Public NotInheritable Class About
        ...
        Private Sub InitializeComponent()
            ...
            size = New Size(&H5C, &H10)
            Me.NomeLab.Size = size
            Me.NomeLab.TabIndex = 1
            Me.NomeLab.Text = "Power Diary"
            ...
            Me.PictureBox1.Image = Resources.Power_diary
            ...
            Me.Name = "InformazioniSu"
            Dim padding As New Padding(9)
            Me.Padding = padding
            Me.ShowInTaskbar = False
            Me.StartPosition = FormStartPosition.CenterParent
            Me.Text = "Informazioni su Power Diary"
        ...
        Private Sub LinkLabel2_LinkClicked_1(ByVal sender As Object, ByVal e As LinkLabelLinkClickedEventArgs)
        ...
        Friend Overridable Property LinkLabel2 As LinkLabel
            ...
            Set(ByVal WithEventsValue As LinkLabel)
                If (Not Me._LinkLabel2 Is Nothing) Then
                    RemoveHandler Me._LinkLabel2.LinkClicked, New LinkLabelLinkClickedEventHandler(AddressOf Me.LinkLabel2_LinkClicked_1)
                End If
                Me._LinkLabel2 = WithEventsValue
                If (Not Me._LinkLabel2 Is Nothing) Then
                    AddHandler Me._LinkLabel2.LinkClicked, New LinkLabelLinkClickedEventHandler(AddressOf Me.LinkLabel2_LinkClicked_1)
                End If
            End Set
        End Property
